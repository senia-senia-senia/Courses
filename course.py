...
#   if cmd == 0:
#        print('''1.trpAdd() --- Функция работает как trpaddstr.''')   
#       print('''2.trpSort() --- Функция сортирует триплексную строку в лексикографическом порядке имен. ''')
#        print('''3.trpDelPref() --- Функция удаляет все триплеты с заданным префиксом из триплексной строки.''')
#        print('''4.trpGet() --- Функция ищет по префиксу объекта pref и имени name в строке trpstr значение  триплета и кладет его  в текстовую строку value, тип значение в type. Возвращает true, если значение есть, иначе false.''')
#        print('''5.trp_Get() --- Тоже, но без type.''')
#        print('''6.trpGetName() --- Функция возвращает имя первого триплета в триплексной строке.''')
#        print('''7.del_trp() --- Функция удаляет  триплеты с заданным префиксом и именем  из триплексной строки. ''')
#        print('''8.trpGoNext() --- Функция переводит указатель на следующий триплет в строке.''')
#        print('''9.trpGoEnd() --- Функция переводит указатель на конец триплексной строчки.''')
#        print('''10.trpGoName() --- Функция аналогична trpgetname''')
#        print('''11.trp_GetFirst() --- Функция возвращает указатель на первый триплет (префикс) и берет его значение.''')
#        print('''12.helpFunction() --- Функция возвращает подробную информацию о функциях, а также о каэждой из функций по отдельности.''')
